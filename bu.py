...
class Command(BaseCommand):
						...
						for ko in tile['data']:
							...
							if key in nodes:
								...
								if nodes[key]['datatype'] == 'resource-instance':
									...
									if len(id) == 0:
										self.__error(passed_uid, "Cannot resolve linked resource: '" + str(tile['data'][key]) + "' is not in the database.")
	...
	def __resourceinstance_from_eamenaid(self, eamenaid, graphid):
